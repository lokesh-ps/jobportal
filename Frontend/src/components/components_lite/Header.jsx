    ...
    <div>
      <div className="text-center">
        <div className="flex flex-col gap-5 my-10">
          <span className="px-4 flex flex-row items-center mx-auto py-2 rounded-full bg-gray-200 text-red-600 font-medium">
            <PiBuildingOfficeBold className="mx-2 text-[#614232]" />
